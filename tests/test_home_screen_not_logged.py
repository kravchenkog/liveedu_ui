...
class TestClass():
    ...
    def test_WHEN_home_screen_open_AND_not_logged_EXPECTED_sign_up_button_is_presented_TC1000(self):
        assert self.app.home_el.button_signup_is_presented()
